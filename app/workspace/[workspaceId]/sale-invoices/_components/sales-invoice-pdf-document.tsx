...
export type SalesInvoicePdfCompany = {
  legalName: string;
  displayName: string;
  email: string;
  phone: string;
...
const STATUS_PILL: Record<SalesInvoiceStatus, { bg: string; fg: string }> = {
...
function HeroBackground() {
  return (
    <Svg width={PAGE_W} height={HERO_H} style={styles.heroSvg}>
      <Defs>
        <LinearGradient id="invoiceHero" x1="0" y1="0" x2="1" y2="1">
    ...
    <View style={styles.footer}>
      ...
      <View style={styles.footerCenter}>
        <Text style={styles.footerThanks}>
          Thank you for your business with {sellerName}.
        </Text>
...
export function SalesInvoicePdfDocument({
  company,
  invoice,
}: {
  company: SalesInvoicePdfCompany;
  invoice: SalesInvoicePdfData;
}) {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.hero}>
          ...
          <View style={styles.heroContent}>
            ...
            <View style={styles.heroRight}>
              ...
              >
                {SALES_INVOICE_STATUS_LABEL[invoice.status]}
              </Text>
        ...
        <View style={styles.cardsRow}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.cardName}>{invoice.customer.name}</Text>
            {invoice.customer.company ? (
              <Text style={styles.cardLine}>{invoice.customer.company}</Text>
            ) : null}
            {invoice.customer.email ? (
              <Text style={styles.cardSubtle}>{invoice.customer.email}</Text>
            ) : null}
